...
const rooms = {
    ...
    sotano: {
        ...
        objects: [
            { id: 'puerta_madera_sotano', name: 'Puerta de madera', coords: { top: '30%', left: '37%', width: '12%', height: '43%' },
                action: (state) => {
            ...
            { id: 'caja_rota', name: 'Caja rota', coords: { top: '60%', left: '14%', width: '25%', height: '25%' },
                action: (state) => {
             ...
             { id: 'tuberia_sotano', name: 'Tubería que gotea', coords: { top: '10%', left: '20%', width: '10%', height: '30%' },
                 action: (state) => {
    ...
    pasillo: {
        ...
        objects: [
            ...
            { id: 'cuadro_antiguo', name: 'Cuadro antiguo', coords: { top: '20%', left: '45%', width: '10%', height: '20%' },
                action: (state) => {
    ...
    vestibulo: {
        ...
        objects: [
            { id: 'puerta_salida', name: 'Puerta de Salida', coords: { top: '10%', left: '35%', width: '30%', height: '80%' },
                action: (state) => {
            ...
            { id: 'volver_pasillo_vestibulo', name: 'Volver al Pasillo', coords: { top: '80%', left: '45%', width: '10%', height: '15%' }, // Puerta atrás
                action: (state) => {
