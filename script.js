...
const rooms = {
    ...
    pasillo: {
        ...
        objects: [
            { id: 'puerta_biblioteca', name: 'Puerta a la Biblioteca', coords: { top: '45%', left: '67%', width: '2%', height: '8%' },
                action: (state) => {
            ...
            { id: 'reloj_parado', name: 'Reloj de pie parado', coords: { top: '30%', left: '40%', width: '6%', height: '10%' },
                action: (state) => {
