...
const rooms = {
    ...
    sotano: {
        ...
        objects: [
            { id: 'puerta_madera_sotano', name: 'Puerta de madera', coords: { top: '30%', left: '37%', width: '10%', height: '45%' },
                action: (state) => {
            ...
            { id: 'caja_rota', name: 'Caja rota', coords: { top: '60%', left: '14%', width: '25%', height: '25%' },
             ...
             { id: 'tuberia_sotano', name: 'Tubería que gotea', coords: { top: '18%', left: '20%', width: '10%', height: '10%' },
                 action: (state) => {
