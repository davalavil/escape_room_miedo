...
const rooms = {
    ...
    pasillo: {
        ...
        objects: [
            { id: 'puerta_biblioteca', name: 'Puerta a la Biblioteca', coords: { top: '25%', left: '55%', width: '15%', height: '40%' },
                action: (state) => {
            ...
            { id: 'cuadro_antiguo', name: 'Cuadro antiguo', coords: { top: '40%', left: '23%', width: '5%', height: '5%' },
                action: (state) => {
